  ...
  return (
    <section id="Contato" className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="border max-w-2xl mx-auto group  h-full  border-[#26262b] rounded-xl flex flex-col ">
          <div className="px-4 py-3 border-b border-[#1B1B20] flex bg-[#101014] gap-4 rounded-t-xl  items-center">
          ...
          <div className="px-8 py-10 rounded-b-xl flex bg-[#101014] flex-col gap-4  items-center">
            ...
            <div className="rounded-xl  w-full max-w-[320px] mb-4 border p-4 bg-[#17171A] text-sm border-[#1E1E23] ">
